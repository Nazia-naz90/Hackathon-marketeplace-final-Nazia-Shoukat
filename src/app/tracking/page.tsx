...
import { TrackingData } from "@/app/types/type.";
...
function TrackShipment() {
  ...
  const handleSubmit = useCallback(async (labelId: string) => { // Use useCallback
    if (!labelId) {
        ...
        {trackingData && (
          <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-4">
              <p>
                <span className="font-semibold">Tracking Number:</span> {trackingData.trackingNumber}
              </p>
              <p>
                <span className="font-semibold">Status:</span> {trackingData.statusDescription}
              </p>
              <p>
                <span className="font-semibold">Carrier Status:</span> {trackingData.carrierStatusDescription || "N/A"}
              </p>
              <p>
                <span className="font-semibold">Estimated Delivery:</span> {trackingData.estimatedDeliveryDate || "N/A"}
              </p>
              <p>
                <span className="font-semibold">Actual Delivery:</span> {trackingData.actualDeliveryDate || "N/A"}
              </p>
            </div>
          </div>
        )}
